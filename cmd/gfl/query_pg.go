...
var (
	...
	test     = []string{
		...
		"content_type=gameStudio&include=3&limit=12&locale=en&order=-fields.priority%2C-sys.updatedAt%2Csys.id&skip=0&sys.id%5Bnin%5D=5TMZX1JgiWM8A2iwukGW8c,2v2sbJZz5S0Q802iQAM4kI",
